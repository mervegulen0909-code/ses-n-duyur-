...
| **Push token** _(planned, N3 — not yet in schema)_                | `push_tokens` (design sketch in `push.ts`)                                                                  | Deliver push notifications                   | Yes                                                                    | No                              |
...
| Identifiers    | Device ID (push token) _(when N3 ships)_   | Yes       | Yes    | No       | App Functionality (notifications)         |
...
| Device or other IDs → Push token _(N3)_                 | Yes       | No     | No                    | Optional           | App functionality (notifications)     |
